...
* 新增函数 wpjam_register_config 和 wpjam_get_config 用户生成全局配置接口
* 新增函数 wpjam_preprocess_register_args 用于预处理注册的参数
* 新增函数 wpjam_add_screen_item 支持添加一个项目到某个界面选项
* 新增函数 get_screen_option 用于获取界面选项
* 新增函数 wpjam_add_option_section 向已有的设置页面添加标签页
* 新增函数 wpjam_add_option_section_fields 向已有的设置页面字段
* 新增函数 wpjam_wrap_tag，支持将文本加上某个标签和属性
* 新增函数 wpjam_add_prefix 和 wpjam_add_postfix 用于添加前缀和后缀
* 新增函数 wpjam_date 和 wpjam_strtotime。
* 新增函数 wpjam_send_error_json 
* 新增函数 wpjam_get_current_priority 获取当前 hook 优先级。
* 新增函数 wpjam_add_prefix 和 wpjam_add_postfix
* 新增函数 wpjam_upload，用于统一处理文件上传
* 新增函数 wpjam_scandir 函数，支持 callback 扫描文件夹
...
* WPJAM_JSON_Module 支持 data_type 接口，用于前端自动完成
...
* 多层分类支持多级联动显示字段
* 修复移动主题扩展失效的 bug
* 修复 setting section show_if 失效的 bug
