...
class WPJAM_Postviews{
	...
	public static function available_callback($post_type, $object){
	...
	public static function init(){
		if(is_admin()){
			wpjam_register_list_table_action('update_views', [
				'data_type'		=> 'post_type',
				'post_type'		=> [self::class, 'available_callback'],
...
wpjam_register_route_module('postviews', ['model'=>'WPJAM_Postviews', 'init'=>true]);
