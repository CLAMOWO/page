		    ...
		    <div id="optionsframework" class="postbox">
				<form action="options.php" method="post">
					...
					<div id="optionsframework-submit">
						...
						<input type="submit" class="reset-button button-secondary" name="reset" value="<?php echo __( '危险操作！点击后将重置全部的主题设置', 'haoui' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'textdomain' ) ); ?>' );" />
						<div class="clear"></div>
					</div>
				</form>
			</div></div>
