...
Description: 实现可视化替换文章内容、标题，评论昵称和评论内容字符。公众号：老蒋玩运营。
Version: 6.1
Author: 老蒋和他的小伙伴
...
function wprelace_setting_page() {
 ...
 <div class="container-laobuluo-main">
    <div class="laobuluo-wbs-header" style="margin-bottom: 15px;">
              <div class="laobuluo-wbs-logo"><a><img src="<?php echo plugin_dir_url( __FILE__ );?>layui/images/logo.png"></a><span class="wbs-span">WPReplace - 批量替换插件</span><span class="wbs-free">Free V5.4</span></div>
            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-md12">
                    ...
                    <div class="laobuluo-links">
                        ...
                        <a href="https://www.lezaiyun.com/?utm_source=wpreplace-setting&utm_media=link&utm_campaign=footer"  target="_blank">插件官方</a>                       
