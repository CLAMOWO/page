  ...
  return {
    ...
    template: `
      ...
      <div class="uip-flex uip-flex-between">
        <div class="uip-text-bold uip-margin-bottom-xxs uip-chart-title">{{returnName}}</div>
      ...
      <div v-else-if="error && errorMessage" class="uip-padding-xxs uip-border-round uip-background-orange-wash uip-text-bold uip-margin-bottom-s uip-scale-in-top uip-max-w-200">{{errorMessage}}</div>
